...
$a=Find-PSOneDuplicateFile
#$b = $a.values |out-string -Stream | Select-Object -Skip 3  | ConvertFrom-String | Select-Object @{l='Name';e='P6'}, @{l='Size (B)';e='P5'}
#$b
#$a.values.FullName | Out-File -FilePath .\test.txt
$a | Out-GridView -Title 'Duplicate Files' 